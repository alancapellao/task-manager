<x-form :title="__('pagination.list')" :action="route('lists.store')" form="lists" method="POST">
        ...
        <div class="form-group">
                ...
                <textarea name="description" id="description" placeholder="{{ __('pagination.enter_the_description') }}"></textarea>
        </div>
